...
import ArgumentType from 'haniblock-vm/src/extension-support/argument-type';
import BlockType from 'haniblock-vm/src/extension-support/block-type';
...
const defineDynamicBlock = (ScratchBlocks, categoryInfo, staticBlockInfo, extendedOpcode) => ({
    init: function () {
        ...
        // There is a haniblock-blocks / Blockly extension called "scratch_extension" which adjusts the styling of
        // blocks to allow for an icon, a feature of Scratch extension blocks. However, Scratch "core" extension
        // blocks don't have icons and so they should not use 'scratch_extension'. Adding a haniblock-blocks / Blockly
