...
import ScratchBlocks from 'haniblock-blocks';
...
export default function (blockId) {
    // Not sure any better way to access the haniblock-blocks workspace than this...
    ...
    return new Promise(resolve => {
        setTimeout(() => {
            ...
            computedStyleToInlineStyle(svg, {
                ...
                // Specifically properties that are set from CSS in haniblock-blocks
