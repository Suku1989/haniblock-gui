...
const messages = defineMessages({
    label: {
        ...
        defaultMessage: 'Report statistics to improve HaniBlock',
        description: 'HaniBlock telemetry modal label - for accessibility'
    },
    bodyText1: {
        defaultMessage: 'The HaniBlock Team is always looking to better understand how HaniBlock is used around the ' +
            'world. To help support this effort, you can allow HaniBlock to automatically send usage information to ' +
            'the HaniBlock Team.',
    ...
    privacyPolicyLink: {
        ...
        description: 'Link to the HaniBlock privacy policy',
        id: 'gui.telemetryOptIn.privacyPolicyLink'
    },
    optInText: {
        defaultMessage: 'Share my usage data with the HaniBlock Team',
    ...
    optOutText: {
        defaultMessage: 'Do not share my usage data with the HaniBlock Team',
        description: 'Text for telemetry modal opt-in button',
