        ...
        <div dir={props.isRtl ? 'rtl' : 'ltr'}>
            ...
            <Box className={styles.body}>
                ...
                <p>
                    ...
                    <FormattedMessage
                        defaultMessage="Unfortunately it looks like your browser or computer {webGlLink}. This technology is needed for HaniBlock to run."
                ...
                <div className={styles.faqLinkText}>
                    <FormattedMessage
                        ...
                        description="HaniBlock FAQ description"
                        ...
                        values={{
                            previewFaqLink: (
                                ...
                                >
                                    <FormattedMessage
                                        defaultMessage="FAQ"
                                        description="link to HaniBlock FAQ page"
